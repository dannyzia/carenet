...
export default function GuardianPlacementDetailPage() {
  ...
  if (loading || !detailData) return <PageSkeleton cards={4} />;
    ...
    <>
      <div className="max-w-3xl mx-auto space-y-6 pb-8">
        ...
        <div className="finance-card p-5" style={{ boxShadow: `0 0 0 2px ${cn.greenBg}` }}>
          ...
          <div className="flex items-center gap-3 mb-3"><div className="w-10 h-10 rounded-full flex items-center justify-center text-xs" style={{ background: cn.pinkBg, color: cn.pink }}>KU</div><div className="flex-1"><p className="text-sm" style={{ color: cn.text }}>Karim Uddin</p><p className="text-xs" style={{ color: cn.textSecondary }}>Night Shift: 8:00 PM - 8:00 AM</p></div><span className="px-2 py-0.5 rounded-full text-xs animate-pulse" style={{ background: cn.greenBg, color: cn.green }}>Checked In</span></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="finance-card p-4"><h3 className="text-sm mb-2" style={{ color: cn.text }}>Financial Summary</h3><div className="space-y-1.5 text-sm"><div className="flex justify-between"><span style={{ color: cn.textSecondary }}>Total Billed</span><span style={{ color: cn.text }}>৳ 75,600</span></div><div className="flex justify-between"><span style={{ color: cn.textSecondary }}>Paid</span><span style={{ color: cn.green }}>৳ 64,800</span></div><div className="flex justify-between"><span style={{ color: cn.textSecondary }}>Outstanding</span><span style={{ color: cn.amber }}>৳ 10,800</span></div></div></div>
