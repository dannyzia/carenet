...
export default function ProductEditorPage() {
  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto px-6 -mt-16"><div className="grid grid-cols-1 lg:grid-cols-3 gap-8"><div className="lg:col-span-2 space-y-6"><div className="finance-card p-8">{activeTab === "basic" && (<div className="space-y-6"><h2 className="text-lg font-bold text-gray-800">General Information</h2><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Product Name</label><input className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-bold text-gray-800" placeholder="e.g. Omron M2 Basic Blood Pressure Monitor" value={product.productName} /></div><div className="grid grid-cols-2 gap-6"><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Category</label><select className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-bold text-gray-800"><option>Monitoring</option><option>Mobility</option><option>Surgical</option></select></div><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Brand</label><input className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-bold text-gray-800" placeholder="Omron" value={product.brand} /></div></div><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Full Description</label><textarea className="w-full p-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-medium text-gray-600 min-h-[160px]" placeholder="Write a detailed description..." value={product.fullDescription} /></div></div>)}{activeTab === "pricing" && (<div className="space-y-6"><h2 className="text-lg font-bold text-gray-800">Commercial Details</h2><div className="grid grid-cols-2 gap-6"><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Retail Price ({"\u09F3"})</label><input type="number" className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-black text-gray-800" placeholder="3500" value={product.retailPrice} /></div><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Discounted Price ({"\u09F3"})</label><input type="number" className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-black text-[#7CE577]" placeholder="3200" value={product.discountedPrice} /></div></div><div className="grid grid-cols-2 gap-6"><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Stock Quantity</label><input type="number" className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-bold text-gray-800" placeholder="50" value={product.stockQuantity} /></div><div className="space-y-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">SKU / ID</label><input className="w-full h-14 px-5 rounded-2xl bg-gray-50 border border-gray-100 outline-none font-bold text-gray-400" placeholder="OM-BP-001" value={product.sku} /></div></div></div>)}{activeTab === "media" && (<div className="space-y-6"><h2 className="text-lg font-bold text-gray-800">Product Media</h2><div className="grid grid-cols-3 gap-4"><div className="aspect-square rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 hover:border-[#7CE577] hover:bg-[#E8F9E7]/20 cursor-pointer transition-all"><Plus className="w-6 h-6 mb-2" /><span className="text-[10px] font-bold uppercase">Add Photo</span></div></div></div>)}</div></div><div className="lg:col-span-1 space-y-6"><div className="finance-card p-8"><h3 className="font-bold text-gray-800 mb-6 flex items-center gap-2"><BarChart className="w-4 h-4 text-[#7CE577]" />Optimization Score</h3><div className="space-y-4"><div className="flex justify-between items-end mb-1"><span className="text-xs font-bold text-gray-500">Completeness</span><span className="text-lg font-black text-[#7CE577]">{product.optimizationScore}%</span></div><div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden"><div className="h-full bg-[#7CE577]" style={{ width: `${product.optimizationScore}%` }} /></div><div className="space-y-2 pt-4">{product.keywords.map((keyword, index) => (
