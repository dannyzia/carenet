  ...
  return (
    <>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3"><div><h1 className="text-xl" style={{ color: cn.text }}>My Care Requirements</h1><p className="text-sm" style={{ color: cn.textSecondary }}>Track care requirements submitted to agencies</p></div><Link to="/guardian/care-requirement-wizard" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-white text-sm" style={{ background: "var(--cn-gradient-guardian)" }}><Plus className="w-4 h-4" /> New Requirement</Link></div>
