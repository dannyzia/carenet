  ...
  return (
    <>
      <div className="max-w-3xl mx-auto space-y-6 pb-8">
        <Link to="/guardian/care-requirements" className="inline-flex items-center gap-1 text-sm" style={{ color: cn.textSecondary }}><ChevronLeft className="w-4 h-4" /> Back to Requirements</Link>
