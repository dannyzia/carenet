...
export default function ClientIntakePage() {
  ...
  const { data, loading, error } = useAsyncData(() => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve([
          { title: "Square Hospital - Ward 4", units: "12 beds", status: "Active", date: "Mar 12, 2026" },
          { title: "Apollo Health Group - NICU", units: "5 staff", status: "Negotiating", date: "Mar 10, 2026" },
          { title: "Evercare - Geriatric Wing", units: "20 staff", status: "Active", date: "Mar 05, 2026" }
        ]);
      }, 1000);
    });
  });
